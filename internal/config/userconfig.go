...
type UserConfig struct {
	...
	TerminalTheme         string                  `toml:"terminal_theme"` // default content theme for all terminals (empty = use Theme)
...
func SaveUserConfig(cfg UserConfig) error {
	...
	if cfg.TerminalTheme != "" {
		sb.WriteString("terminal_theme = \"")
		sb.WriteString(cfg.TerminalTheme)
		sb.WriteString("\"\n")
	}
	if cfg.IconsOnly {
