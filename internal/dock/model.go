...
type DockCell struct {
	...
	Padding     bool   // true = outside the item span (left/right filler), renderer may drop it for pill mode
}
...
type Dock struct {
	...
	Pill            bool   // true = render as centered rounded pill with transparent sides
}
