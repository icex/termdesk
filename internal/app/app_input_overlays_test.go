...
func TestSettingsKeyEnterTogglesBoolean(t *testing.T) {
	m := setupReadyModel()
	m.settings.Show()
	// Navigate to a toggle item (index 2 = "Animations"; terminal_theme is at 1)
	m.settings.SetItem(2)
...
func TestSettingsKeySpaceTogglesBoolean(t *testing.T) {
	m := setupReadyModel()
	m.settings.Show()
	m.settings.SetItem(2) // Animations toggle (terminal_theme at 1)
...
func TestSettingsKeyEscAppliesSettings(t *testing.T) {
	...
	m.settings.SetItem(2) // Animations (terminal_theme at 1)
